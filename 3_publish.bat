...
copy /Y GoSubTitleSearcher_x32.exe _publish\GoSubTitleSearcher\GoSubTitleSearcher.exe
cd _publish
..\_bin\zip.exe -r GoSubTitleSearcher_x32.zip GoSubTitleSearcher
cd..

copy /Y GoSubTitleSearcher_x64.exe _publish\GoSubTitleSearcher\GoSubTitleSearcher.exe
